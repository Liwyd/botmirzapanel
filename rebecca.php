...
#-----------------------------#
function token_panel_rebecca($code_panel){
...
function getuser_rebecca($usernameac,$location)
{
...
#-----------------------------#
function ResetUserDataUsage_rebecca($usernameac,$location)
{
    $marzban_list_get = select("marzban_panel", "*", "name_panel", $location,"select");
    $Check_token = token_panel_rebecca($marzban_list_get['id']);
...
#-----------------------------#
function adduser_rebecca($username,$expire,$data_limit,$location,$is_test = false)
{
    $marzban_list_get = select("marzban_panel", "*", "name_panel", $location,"select");
    $Check_token = token_panel_rebecca($marzban_list_get['id']);
    ...
    $data = array(
        "service_id" => intval($marzban_list_get['inboundid']),
...
#-----------------------------------------------#
function revoke_sub_rebecca($username,$location)
{
    global $connect;
    $marzban_list_get = select("marzban_panel", "*", "name_panel", $location,"select");
    $Check_token = token_panel_rebecca($marzban_list_get['id']);
